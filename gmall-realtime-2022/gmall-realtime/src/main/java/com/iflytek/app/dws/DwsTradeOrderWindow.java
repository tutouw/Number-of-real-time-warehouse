...
public class DwsTradeOrderWindow {
    public static void main(String[] args) throws Exception {
        ...
        SingleOutputStreamOperator<JSONObject> orderDetailJsonObjDS = OrderDetailFilterFunction.getDwdOrderDetail(env, group_id);

        // TODO 6、提取事件时间生成watermark
        SingleOutputStreamOperator<JSONObject> jsonObjWIthWMDS =
                orderDetailJsonObjDS.assignTimestampsAndWatermarks(WatermarkStrategy.<JSONObject>forBoundedOutOfOrderness(Duration.ofSeconds(2))
