...
public class DwdTradeRefundPaySuc {
    public static void main(String[] args) throws Exception {
        ...
        tableEnv.executeSql("create table gmall_db(" +
                ...
                "`ts` string " +
                ")" + MyKafkaUtil.getKafkaDDL("gmall_db", "dwd_trade_refund_pay_suc"));
...
//                        "and `old`['refund_status'] is not null"
        ...
        tableEnv.executeSql("insert into dwd_trade_refund_pay_suc select * from result_table").print();
